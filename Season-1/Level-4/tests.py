...
class TestDatabase(unittest.TestCase): 
    ...
    # Test for correct retrieval of stock info given a symbol
    def test_1(self):
        #op = c.DB_CRUD_ops()
        op = c.SecureStockDB(log_mode='compatible')
    ...
    # Test for SQLi defense — should block injected input
    def test_2(self):
        #op = c.DB_CRUD_ops()
        op = c.SecureStockDB(log_mode='compatible')
    ...
    # Test for correct retrieval of stock price
    def test_3(self):
        #op = c.DB_CRUD_ops()
        op = c.SecureStockDB(log_mode='compatible')
    ...
    # Test for correct update of stock price given symbol and updated price
    def test_4(self):
        #op = c.DB_CRUD_ops()
        op = c.SecureStockDB(log_mode='compatible')
